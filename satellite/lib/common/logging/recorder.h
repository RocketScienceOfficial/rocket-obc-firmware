...
#define FUNCTION_PROFILE_BEGIN_INTERNAL(func) int profileBeginResult = functionProfileBegin(func)
#define FUNCTION_PROFILE_BEGIN() FUNCTION_PROFILE_BEGIN_INTERNAL(__FUNCTION__)
#define FUNCTION_PROFILE_END_INTERNAL(func, result) functionProfileEnd(func, result)
#define FUNCTION_PROFILE_END() FUNCTION_PROFILE_END_INTERNAL(__FUNCTION__, profileBeginResult)