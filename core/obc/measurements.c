...
{
    bmi088_accel_init_i2c(&s_BMI088AccelConfig, I2C_INST, false);
    ...
    bmi088_gyro_init_i2c(&s_BMI088GyroConfig, I2C_INST, false);
    ...
    lsm6dso32_init_i2c(&s_LSM6DSO32Config, I2C_INST);
    ...
    h3lis331dl_init_i2c(&s_H3LIS331DLConfig, I2C_INST);
    ...
    bmp581_init_i2c(&s_BMP581Config, I2C_INST);
    ...
    ublox_sam_m10q_init_i2c(&s_UBloxSamM10QConfig, I2C_INST);
