...
#define DETONATOR_1_PIN 21
#define DETONATOR_2_PIN 22
#define DETONATOR_3_PIN 23
#define DETONATOR_4_PIN 7
#define DETONATOR_1_CON_PIN 26
#define DETONATOR_2_CON_PIN 27
#define DETONATOR_3_CON_PIN 28
#define DETONATOR_4_CON_PIN 29
