...
#define BMI088_ACCEL_CS_PIN 30
#define BMI088_GYRO_CS_PIN 30
#define BME688_CS_PIN 30
#define H3LIS331DL_CS_PIN 30
#define LSM6DSO32_CS_PIN 30
#define MMC5983MA_CS_PIN 30
#define UBLOX_NEO_M9N_CS_PIN 30
#define SDA 14
#define SCL 13
