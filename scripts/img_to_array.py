...
# Taken from: https://github.com/raspberrypi/pico-examples/blob/develop/i2c/oled_i2c/img_to_array.py
...
if img_width > OLED_WIDTH or img_height > OLED_HEIGHT:
    print(
        f'Your image is f{img_width} pixels wide and {img_height} pixels high, but...')
    raise Exception(
        f"OLED display only {OLED_WIDTH} pixels wide and {OLED_HEIGHT} pixels high!")
