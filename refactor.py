"""
TODO: 
 - Add 'hal_' prefix! (gpio_func)
 - Remove private functions (to static functions) and static variables
 - Pointer -> Return
"""
...
PATH = r"D:\Data\Dev\Repos\rocket-obc\modules\drivers"
PATH_MAPPINGS = r"D:\Data\Dev\Repos\rocket-obc\refactor_mappings.json"
...
result = [y for x in os.walk(PATH) for y in glob(os.path.join(x[0], '*.h'))]
...
for path in result:
    with open(path, "r") as f:
        ...
        #         "#pragma once", f"#ifndef {header_guard_name}\n#define {header_guard_name}"
        #     )
